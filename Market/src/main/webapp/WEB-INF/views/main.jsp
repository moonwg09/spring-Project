					...
					<div class="Main_a_div">
						<div class="Main_a_Title">
							...
							<div class="Main_a_Button">
								<%-- <c:if test="${member == null}"> --%>
								<a href="/transation/writeProduct" class="Main_aa_Button"> 판매하기 <!--Signup.html-->
								</a> 
								<%-- </c:if> --%>
				...
				<div class="Main_b_Content">
					...
					<div>
						...
						<div class="Main_b_Button">
							<a class="TextBtn" href="/transation/usedTransation">인기 매물 보기 <!--인기 매물 보기 클릭 .html-->
				...
				<div class="Main_a_Top">
					<div class="Main_a_div">
						<div class="Main_a_Title">
							...
							<div class="Main_a_Button">
								<%-- <c:if test="${member == null}"> --%>
								<a href="/member/check" class="Main_aa_Button"> 회원가입 <!--Signup.html-->
